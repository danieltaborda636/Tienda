...
<link rel="stylesheet" href="http://localhost/tienda_motos/Tienda/assets/css/crear_producto.css">
...
<div class="crear_producto">
            ...
            <?php
                switch ($_GET['mensaje']) {
                    ...
                    case 'faltan_campos':
                        ...
                        break;
                    default:
                        echo "<p style='color:orange;'>⚠️ Ocurrió un error inesperado.</p>";
                        break;
                }
            ?>
        </div>
    ...
    <div class="crearproducto">
            ...
            <input class="imagen" type="file" id="img" name="img" accept="image/*" required><br><br>
